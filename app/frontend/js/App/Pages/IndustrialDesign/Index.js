...
class IndustrialDesign extends Component {
  ...
  componentDidMount(){
    this.props.fetchArticleList(1, 'industrail_design', 'portfolio');
...
IndustrialDesign.contextTypes = {
  router: React.PropTypes.object.isRequired
};

IndustrialDesign.propTypes = {
  locale: React.PropTypes.string.isRequired,
  articleList: React.PropTypes.array.isRequired,
  fetchArticleList: React.PropTypes.func.isRequired,
}

export default connect(mapStateToProps, mapDispatchToProps)(IndustrialDesign);