...
class LogoDesign extends Component {
  ...
  componentDidMount(){
    this.props.fetchArticleList(1, 'logo_design', 'portfolio');
...
LogoDesign.contextTypes = {
  router: React.PropTypes.object.isRequired
};

LogoDesign.propTypes = {
  locale: React.PropTypes.string.isRequired,
  articleList: React.PropTypes.array.isRequired,
  fetchArticleList: React.PropTypes.func.isRequired,
}

export default connect(mapStateToProps, mapDispatchToProps)(LogoDesign);